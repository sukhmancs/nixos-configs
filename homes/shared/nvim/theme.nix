...
in
  ...
  */
  ''
    let g:colors_name="nix-${polarity}"
    ...
    hi Normal        guifg=#${c.base05} guibg=#${c.base02} gui=NONE guisp=NONE
    ...
    hi Error         guifg=#${c.base02} guibg=#${c.base08} gui=NONE guisp=NONE
    hi ErrorMsg      guifg=#${c.base08} guibg=#${c.base02} gui=NONE guisp=NONE
    hi Exception     guifg=#${c.base08} guibg=NONE gui=NONE guisp=NONE
    hi FoldColumn    guifg=#${c.base0C} guibg=#${c.base02} gui=NONE guisp=NONE
    hi Folded        guifg=#${c.base0E} guibg=#${c.base03} gui=NONE guisp=NONE
    ...
    hi Conceal       guifg=#${c.base0D} guibg=#${c.base02} gui=NONE guisp=NONE
    hi Cursor        guifg=#${c.base02} guibg=#${c.base05} gui=NONE guisp=NONE
    hi NonText       guifg=#${c.base03} guibg=NONE gui=NONE guisp=NONE
    hi LineNr        guifg=#${c.base04} guibg=#${c.base02} gui=NONE guisp=NONE
    hi SignColumn    guifg=#${c.base04} guibg=#${c.base02} gui=NONE guisp=NONE
    hi StatusLine    guifg=#${c.base04} guibg=#${c.base02} gui=NONE guisp=NONE
    hi StatusLineNC  guifg=#${c.base01} guibg=#${c.base01} gui=NONE guisp=NONE
    hi VertSplit     guifg=#${c.base01} guibg=#${c.base02} gui=NONE guisp=NONE
    ...
    hi EndOfBuffer   guifg=#${c.base02} guibg=NONE gui=NONE guisp=NONE
    ...
    hi DiffAdd      guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffChange   guifg=#${c.base03} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffDelete   guifg=#${c.base08} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffText     guifg=#${c.base0D} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffAdded    guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffFile     guifg=#${c.base08} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffNewFile  guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffLine     guifg=#${c.base0D} guibg=#${c.base02} gui=NONE guisp=NONE
    hi DiffRemoved  guifg=#${c.base08} guibg=#${c.base02} gui=NONE guisp=NONE
    ...
    hi GitGutterAdd           guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi GitGutterChange        guifg=#${c.base0D} guibg=#${c.base02} gui=NONE guisp=NONE
    hi GitGutterDelete        guifg=#${c.base08} guibg=#${c.base02} gui=NONE guisp=NONE
    hi GitGutterChangeDelete  guifg=#${c.base0E} guibg=#${c.base02} gui=NONE guisp=NONE
    ...
    hi TSUnderline           guifg=#${c.base02} guibg=NONE gui=underline guisp=NONE
    hi TSStrike              guifg=#${c.base02} guibg=NONE gui=strikethrough guisp=NONE
    ...
    hi NvimTreeNormal        guifg=#${c.base05} guibg=#${c.base02} gui=NONE guisp=NONE
    ...
    hi BufferCurrent         guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi BufferCurrentIndex    guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi BufferCurrentMod      guifg=#${c.base0E} guibg=#${c.base02} gui=NONE guisp=NONE
    hi BufferCurrentSign     guifg=#${c.base0B} guibg=#${c.base02} gui=NONE guisp=NONE
    hi BufferCurrentTarget   guifg=#${c.base08} guibg=#${c.base02} gui=NONE guisp=NONE
    hi BufferCurrentIcon     guifg=NONE guibg=#${c.base02} gui=NONE guisp=NONE
    ...
    hi NvimInternalError  guifg=#${c.base02} guibg=#${c.base08} gui=NONE guisp=NONE

    hi NormalFloat   guifg=#${c.base05} guibg=#${c.base02} gui=NONE guisp=NONE
    hi FloatBorder   guifg=#${c.base05} guibg=#${c.base02} gui=NONE guisp=NONE
    hi NormalNC      guifg=#${c.base05} guibg=#${c.base02} gui=NONE guisp=NONE
    hi TermCursor    guifg=#${c.base02} guibg=#${c.base05} gui=NONE guisp=NONE
    hi TermCursorNC  guifg=#${c.base02} guibg=#${c.base05} gui=NONE guisp=NONE
    ...
    hi User8  guifg=#${c.base02} guibg=#${c.base02} gui=NONE guisp=NONE
    hi User9  guifg=#${c.base02} guibg=#${c.base02} gui=NONE guisp=NONE

    hi TreesitterContext  guifg=NONE guibg=#${c.base01} gui=NONE guisp=NONE "was italic

    let g:terminal_color_background = "#${c.base02}"
    let g:terminal_color_foreground = "#${c.base05}"

    let g:terminal_color_0  = "#${c.base02}"
    ...
    let g:terminal_color_15 = "#${c.base0E}"
  ''